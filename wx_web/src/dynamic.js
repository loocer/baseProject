...
function registerModel(app, model) {
  model = model.default || model; // eslint-disable-line
...
function asyncComponent(config) {
  ...
  return class DynamicComponent extends Component {
    ...
    render() {
      ...
      return (<div ref={(node) => { this.component = node; }} style={{ width: '100%', height: '100%' }}>
        {AsyncComponent ? <AsyncComponent {...this.props} /> : <LoadingComponent {...this.props} />}
      </div>);
    }
  };
}
