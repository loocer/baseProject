import { groundWidth, groundHeight, screenWidth, screenHeight } from '../utils/common';
export const renderLoding = (ctx, finish) => {
  let length = (screenWidth - 300) / 2;
  let leftP = (screenWidth - 386) / 2; // let iniY = (screenHeight - panelWidth * (200 / 470)) / 2 
...
export const initRender = (ctx, core, image) => {
  ...
  ctx.font = "20px Arial";
  ctx.fillText(~~core + '%', screenWidth / 2 - 20, iniY + panelWidth * (200 / 470) - 40);
