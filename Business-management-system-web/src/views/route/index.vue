  ...
  <div>
    ...
    <div class="app-container">
      <div class="container-header">
        <el-button type="primary" style="margin-bottom: 20px;" v-on:click="openDiaLoag(1,null)">新建区域</el-button>
      </div>
      <el-table
        ...
        <el-table-column label="访问路劲" min-width="230" align="center">
          <template slot-scope="scope">
            {{ scope.row.url }}
          </template>
        </el-table-column>
        <el-table-column label="创建者" min-width="190" align="center">
          <template slot-scope="scope">
            {{ scope.row.updater }}
          </template>
        </el-table-column>
