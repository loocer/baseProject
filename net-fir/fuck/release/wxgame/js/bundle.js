(function () {
           ...
           scaleBig(e)
            ...
            leftFormatMovePosition(px,py) {
              ...
              if(45<rote&&rote<135){//w
                  console.log(1);
                  utl.cubec.transform.translate(new Laya.Vector3(0,0,.03),true);
    ...
    class GameUI extends Laya.Scene {
      ...
      //       utl.camera = camera
            ...
            Laya.Sprite3D.load("res/Conventional/Directional Light.lh", Laya.Handler.create(null, (sp)=> {
                let layaMonkey1 = this.newScene.addChild(sp);
                // layaMonkey2.transform.position =new Laya.Vector3(0,3,5)
            }));
            Laya.Sprite3D.load("res/Conventional/cn.lh", Laya.Handler.create(null, (sp)=> {
                var layaMonkey2 = this.newScene.addChild(sp);
                utl.camera = sp;
                 // utl.camera.transform.position =new Laya.Vector3(0,1,3)
                // layaMonkey2.transform.position =new Laya.Vector3(0,3,5)
            }));
            Laya.Sprite3D.load("res/Conventional/cu.lh", Laya.Handler.create(null, (sp)=> {
                var layaMonkey2 = this.newScene.addChild(sp);
                utl.cubec = sp;
