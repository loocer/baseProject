...
export default {
  ...
  methods: {
    ...
    handleAvatarSuccess2(res, file) {
      ...
      this.img2 = formatImg(file.response.key)
    },
    handleAvatarSuccess3(res, file) {
      ...
      this.img3 = formatImg(file.response.key);
    },
    handleAvatarSuccess4(res, file) {
      console.log(res)
      console.log(file)
      this.img4 = formatImg(file.response.key);
      const ingf = {
    ...
    cancel1(){
      this.resetFiled()
      this.$emit('dialogMsg', {status:true})
    },
    onSubmit(){
      this.formatTime()
      ...
      const userId = VehicleVO.userId = this.JiekuanUser.userId
      this.$store.dispatch('addCar', {curruid, commercialId, VehicleVO})
      // this.$store.dispatch('addCartoList',{curruid, commercialId, VehicleVO})
